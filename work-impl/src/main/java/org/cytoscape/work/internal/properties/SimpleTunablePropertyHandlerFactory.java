...
public class SimpleTunablePropertyHandlerFactory<T extends TunablePropertyHandler> extends BasicTunableHandlerFactory<T> implements TunablePropertyHandlerFactory<T> {

	
	public SimpleTunablePropertyHandlerFactory(Class<T> specificHandlerType, Class<?>... classesToMatch ) {

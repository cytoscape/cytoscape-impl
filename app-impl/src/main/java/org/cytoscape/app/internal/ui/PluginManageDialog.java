...
import org.cytoscape.app.internal.PluginException;
import org.cytoscape.app.internal.PluginInfo;
import org.cytoscape.app.internal.PluginInquireAction;
import org.cytoscape.app.internal.PluginManager;
import org.cytoscape.app.internal.PluginManagerInquireTask;
import org.cytoscape.app.internal.PluginManagerInquireTaskFactory;
...
public class PluginManageDialog extends javax.swing.JDialog implements
	...
	private static final Logger logger = LoggerFactory.getLogger(PluginManageDialog.class);
...
*/
	...
	private void refreshPluginTree(){
		...
		Task task = new PluginManagerInquireTask
	...
	*/
	private class UrlAction extends PluginInquireAction {
		...
		public void inquireAction(List<DownloadableInfo> Results) {
			...
			if (isExceptionThrown()) {
				...
				System.out.println("PluginManagerDialog.inquireAction().....");
	...
	private class PluginManagerInstallTaskFactory implements TaskFactory {
		Task task;
		public PluginManagerInstallTaskFactory(Task task){
			this.task = task;
		}

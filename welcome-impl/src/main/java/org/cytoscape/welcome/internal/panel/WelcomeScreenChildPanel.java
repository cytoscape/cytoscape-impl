...
public interface WelcomeScreenChildPanel {
	...
	public static final Font TITLE_FONT = UIManager.getFont("Label.font").deriveFont(Font.BOLD, 14.0f);
	
	public static final Color LINK_FONT_COLOR = UIManager.getColor("Table.focusCellBackground");
	public static final Color REGULAR_FONT_COLOR = UIManager.getColor("Label.foreground");
	public static final Color TITLE_FONT_COLOR = UIManager.getColor("TextField.background");
	public static final Color TITLE_BG_COLOR = UIManager.getColor("TextField.foreground");

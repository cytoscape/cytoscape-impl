...
/**
 * Commandline handler for the type <i>Boolean</i> of <code>Tunable</code>
 * 
 * @author pasteur
 */
public class BooleanCLHandler extends AbstractCLHandler {
	...
	/**
	 * Constructs the <code>CLHandler</code> for the <code>Boolean</code> type of a Field <code>f</code>
	 * 
	 ...
	 * <li> apply the value to the Boolean Object <code>o</code> contained in <code>f</code> ,or</li>
	 * <li> set the argument as a boolean parameter for the <code>set</code> Method </li>
	 * </ul>
	 * </pre></p>
	 * 

...
public class VDistCenter extends AbstractControlAction {
	...
	public VDistCenter(Icon i,CyApplicationManager appMgr, UndoSupport undoSupport) {
	...
	protected void control(List<View<CyNode>> nodes) {
		...
		for (int i = 0; i < nodes.size(); i++) {
			nodes.get(i).setVisualProperty(BasicVisualLexicon.NODE_Y_LOCATION,Y_min + (i * d));
		}
	}
}

...
public class CyGroupSettingsTaskFactory extends AbstractTaskFactory {
	final CyGroupAggregationManager cyAggManager;
	final CyGroupSettingsImpl settings;
	final CyGroupManagerImpl groupMgr;

	public CyGroupSettingsTaskFactory(final CyGroupManagerImpl groupMgr, 
	...
	public TaskIterator createTaskIterator() {
		CyGroupSettingsTask task = new CyGroupSettingsTask(groupMgr, cyAggManager,
		                                                   settings, null);

...
public class InDegree extends AbstractFunction {
	...
	public Object evaluateFunction(final Object[] args) {
		...
		Long degree = SuidSearchUtil.lookup(registrar, CyNode.class, nodeID, this::indegree);
		if(degree == null) {
	...
	private Long indegree(CyNetwork net, CyNode node) {
		return Long.valueOf(net.getAdjacentEdgeList(node, CyEdge.Type.INCOMING).size());
	}
}

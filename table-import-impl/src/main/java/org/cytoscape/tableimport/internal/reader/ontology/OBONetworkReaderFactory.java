...
public class OBONetworkReaderFactory extends AbstractInputStreamTaskFactory {
	...
	public OBONetworkReaderFactory(final CyFileFilter filter, final CyServiceRegistrar serviceRegistrar) {
		super(filter);
	...
	public TaskIterator createTaskIterator(final InputStream inputStream, final String inputName) {
		return new TaskIterator(new OBOReader(inputName, inputStream, serviceRegistrar));
	}
}

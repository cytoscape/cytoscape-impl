...
public enum ColorGradient {
	...
	ColorGradient(String label, Color down, Color zero, Color up) {
		this.label = label;
		this.up = up;
		this.down = down;
		this.zero = zero;
	...
	public List<Color> getColors() {
		var retColors = new ArrayList<Color>();
		retColors.add(up);
	...
	public static ColorGradient getGradient(String name) {
	...
	private void addGradient(ColorGradient cg) {
		if (cMap == null)
			cMap = new HashMap<String, ColorGradient>();

...
public class CustomGraphicsIcon extends VisualPropertyIcon<CellCustomGraphics> {

	public CustomGraphicsIcon(CellCustomGraphics value, int width, int height, String name) {

...
public class CyActivator extends AbstractCyActivator {
	...
	public void start(BundleContext bc) {
		...
		SIFNetworkReaderFactory sifNetworkViewReaderFactory = new SIFNetworkReaderFactory(sifFilter,cyLayoutsServiceRef,cyNetworkViewFactoryServiceRef,cyNetworkFactoryServiceRef,cyEventHelperRef,cyNetworkManagerServiceRef,cyRootNetworkManagerServiceRef, cyApplicationManagerServiceRef);

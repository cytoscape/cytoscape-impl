...
public class GenericXGMMLWriterNoViewFactory extends AbstractCyWriterFactory implements CyNetworkViewWriterFactory {

	protected final UnrecognizedVisualPropertyManager unrecognizedVisualPropMgr;
	protected final GroupUtil groupUtil;
	protected final CyServiceRegistrar serviceRegistrar;

	public GenericXGMMLWriterNoViewFactory(final CyFileFilter filter,
    ...
    public CyWriter createWriter(OutputStream os, CyNetworkView view) {
		// This writer factory always exports the network without the view
		return createWriter(os, view.getModel());
    }

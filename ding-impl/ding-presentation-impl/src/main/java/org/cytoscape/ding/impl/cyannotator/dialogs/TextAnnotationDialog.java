...
public class TextAnnotationDialog extends JDialog {
	...
	public TextAnnotationDialog(final DGraphView view, final Point2D start, final Window owner) {
		...
		this.mAnnotation = new TextAnnotationImpl(view, owner, false);
		create = true;
		initComponents();
	}
	...
	private void initComponents() {
		...
		preview = new TextAnnotationImpl(view, getOwner(), true);
	...
	private void applyButtonActionPerformed(ActionEvent evt) {
		...
		// Apply
		String name = textAnnotationPanel.getAnnotationName();

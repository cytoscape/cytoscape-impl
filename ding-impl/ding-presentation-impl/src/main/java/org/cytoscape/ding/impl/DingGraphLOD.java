 ...
 * 
 */
public class DingGraphLOD extends GraphLOD implements PropertyChangeListener {
	...
	coarseDetailThreshold = parseInt(props.getProperty("render.coarseDetailThreshold"), 2000);
	nodeBorderThreshold = parseInt(props.getProperty("render.nodeBorderThreshold"), 200);
	nodeLabelThreshold = parseInt(props.getProperty("render.nodeLabelThreshold"), 100);
	edgeArrowThreshold = parseInt(props.getProperty("render.edgeArrowThreshold"), 300);
	edgeLabelThreshold = parseInt(props.getProperty("render.edgeLabelThreshold"), 120);
    }
	...
	if (e.getPropertyName().equals(UPDATED)) {
	    ...
	    if(engine instanceof DGraphView)
		((DGraphView) engine).setGraphLOD(this);

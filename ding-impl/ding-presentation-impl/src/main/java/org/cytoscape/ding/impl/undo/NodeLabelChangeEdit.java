...
public class NodeLabelChangeEdit extends AbstractCyEdit {
	...
	public NodeLabelChangeEdit(CyServiceRegistrar serviceRegistrar, InputHandlerGlassPane listener,
			ObjectPosition previousValue, Double previousRotation, CyNetworkView netview, Long nodeId, String label) {
		super(label);

...
public final class LongBTree implements java.io.Serializable {
	 ...
	 *                 +---+---+---+---+---+---+---+
	 */
	private final static void split(final long newVal, final long[] origBuff,
	                                final long[] overflowBuff, final int overflowCount) {
	...
	private final static long distributeFromLeft(final Node leftSibling, final Node thisSibling,
		...
		if (isLeafNode(leftSibling)) {
			...
			final long returnThis = leftSibling.data.splitVals[leftSibling.sliceCount
			                       - distributeNum - 1];
	 ...
	 */
	public final LongEnumerator searchRange(final long xMin, final long xMax,
	 ...
	 * call to this method.
	 */
	private final static int searchRange(final Node n, final NodeStack nodeStack, final long xMin,
	                                     final long xMax, final long minBound, final long maxBound,
	                                     final boolean reverseOrder) {
		int count = 0;

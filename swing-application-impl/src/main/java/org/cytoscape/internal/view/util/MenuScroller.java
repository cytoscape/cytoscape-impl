...
public class MenuScroller {
	...
	/**
	 * Registers a menu to be scrolled with the default number of items to display
	 * at a time and the default scrolling interval.
	 * 
	 * @param menu the menu
	...
	/**
	 * Registers a menu to be scrolled with the default number of items to display
	 * at a time and the specified scrolling interval.
	 * 
	 * @param menu        the menu
	 ...
	 * @throws IllegalArgumentException if scrollCount or interval is 0 or negative
	 *                                  or if topFixedCount or bottomFixedCount is
	 *                                  negative
	 * @return the MenuScroller
	 */
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a menu with the default
	 ...
	 * default number of items to display at a time, and default scrolling interval.
	 * 
	 * @param menu the popup menu
	 */
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a menu with the specified
	 * number of items to display at a time, and default scrolling interval.
	 * 
	 * @param menu        the menu
	 * @param scrollCount the number of items to display at a time
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a menu with the specified
	 * number of items to display in the scrolling region, the specified scrolling
	 * interval, and the specified numbers of items fixed at the top and bottom of
	 * the menu.
	 * 
	 * @param menu             the menu
	 * @param scrollCount      the number of items to display in the scrolling
	...
	/**
	 * Scrolls the specified item into view each time the menu is opened. Call this
	 * method with <code>null</code> to restore the default behavior, which is to
	 * show the menu as it last appeared.
	 *
	...
	/**
	 * Removes this MenuScroller from the associated menu and restores the default
	...
	/**
	 * Ensures that the <code>dispose</code> method of this MenuScroller is called
	...
	private static enum MenuIcon implements Icon {
		...
		public void paintIcon(Component c, Graphics g, int x, int y) {
			...
			Graphics2D g2 = (Graphics2D) g.create(size.width / 2 - 5, size.height / 2 - 5, 10, 10);
			g2.setRenderingHints(
					new RenderingHints(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON));
			
			g2.setColor(UIManager.getColor(c.isEnabled() ? "Label.foreground" : "Label.disabledForeground"));

...
public class SVGIcon implements Icon {
	...
	public SVGIcon(InputStream is, int width, int height) {
		this.width = width;
		this.height = height;
		
		try (var scan = new Scanner(new BufferedInputStream(is))) {
			...
			createDiagran(sb.toString());
		} catch (Exception e) {
			throw new RuntimeException("Invalid SVG stream.", e);
		}
	}
	...
	private void createDiagran(String svg) {

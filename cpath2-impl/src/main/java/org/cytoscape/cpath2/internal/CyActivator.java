...
public class CyActivator extends AbstractCyActivator {
	...
	public static final Logger LOG = LoggerFactory.getLogger(CyActivator.class);
	...
	public void start(BundleContext bc) {
		...
		LOG.warn("cpath2-impl (older Pathway Commos UI cliet) app is now deprecated/disabled - " +
				"will remove the sources form the core projects later...");

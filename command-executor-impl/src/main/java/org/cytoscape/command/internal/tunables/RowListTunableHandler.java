...
public class RowListTunableHandler extends AbstractStringTunableHandler implements CyIdentifiableTunableHandler {
		private StringToModel stringHandler;
    public RowListTunableHandler(Field f, Object o, Tunable t) { super(f,o,t); }
    public RowListTunableHandler(Method get, Method set, Object o, Tunable t) { super(get,set,o,t); }

...
public class NewNetworkSelectedNodesOnlyTaskFactoryTest {
	...
	public void testObserver() throws Exception {
		...
		NewNetworkSelectedNodesOnlyTaskFactory factory = new NewNetworkSelectedNodesOnlyTaskFactoryImpl(undoSupport, crnf, cnvf, netmgr, networkViewManager, naming, vmm, appManager, eventHelper, groupMgr, renderingEngineMgr);

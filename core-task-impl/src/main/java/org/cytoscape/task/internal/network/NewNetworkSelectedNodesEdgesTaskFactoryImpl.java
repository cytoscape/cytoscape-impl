...
public class NewNetworkSelectedNodesEdgesTaskFactoryImpl extends AbstractNetworkTaskFactory 
	...
	public NewNetworkSelectedNodesEdgesTaskFactoryImpl(CyServiceRegistrar serviceRegistrar) {
		this.serviceRegistrar = serviceRegistrar;
	}

	@Override
	public TaskIterator createTaskIterator(CyNetwork network) {
		return new TaskIterator(3, new NewNetworkSelectedNodesEdgesTask(network, serviceRegistrar));
	}
}

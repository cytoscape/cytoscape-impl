...
public class ExportNetworkViewTaskFactory extends AbstractNetworkViewTaskFactory implements NetworkViewExporter {
	...
	public ExportNetworkViewTaskFactory(CyNetworkViewWriterManager writerManager, TunableSetter tunableSetter) {

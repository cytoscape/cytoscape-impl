...
public class ApplyVisualStyleTaskFactory extends AbstractNetworkViewTaskFactory implements VisualStyleApplier {

	private final VisualMappingManager vmm;
	
	private final TunableSetter tunableSetter; 

	public ApplyVisualStyleTaskFactory(final VisualMappingManager vmm, TunableSetter tunableSetter) {
		this.vmm = vmm;

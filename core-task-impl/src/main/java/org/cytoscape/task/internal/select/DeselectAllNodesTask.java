/*
 File: DeselectAllNodesTask.java
...
public class DeselectAllNodesTask extends AbstractSelectTask {
	...
	public DeselectAllNodesTask(final UndoSupport undoSupport, final CyNetwork net,
	...
	public void run(final TaskMonitor tm) {
		...
		undoSupport.getUndoableEditSupport().postEdit(
			new SelectionEdit(eventHelper, "Deselect All Nodes", network, view,

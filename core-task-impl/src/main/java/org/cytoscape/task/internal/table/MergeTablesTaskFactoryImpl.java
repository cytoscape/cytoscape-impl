...
public class MergeTablesTaskFactoryImpl extends AbstractTaskFactory implements MergeTablesTaskFactory {
	...
	public TaskIterator createTaskIterator() {
		return new TaskIterator(new MergeTablesTask(serviceRegistrar));
	}
	...
	public TaskIterator createTaskIterator(
		...
		ListSingleSelection<String> chooser = new ListSingleSelection<>(MergeTablesTask.NETWORK_COLLECTION,
				MergeTablesTask.NETWORK_SELECTION, MergeTablesTask.UNASSIGNED_TABLE);
		...
		final ListSingleSelection<Object> targetTableList;

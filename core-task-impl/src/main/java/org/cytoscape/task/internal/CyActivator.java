...
public class CyActivator extends AbstractCyActivator {
	...
	private void createNodeEdgeTaskFactories(BundleContext bc, CyServiceRegistrar serviceRegistrar,
		...
		}
		{
			...
			props.setProperty(COMMAND_LONG_DESCRIPTION,
					"Returns a node that matches the passed parameters. If multiple nodes are found, only one will be returned, and a warning will be printed.");
			props.setProperty(COMMAND_SUPPORTS_JSON, "true");
		...
		{
			ListNodesTaskFactory factory = new ListNodesTaskFactory(cyApplicationManagerServiceRef);
			Properties props = new Properties();
			props.setProperty(COMMAND, "list");
			props.setProperty(COMMAND_NAMESPACE, "node");
		...
		}
		{
			...
			props.setProperty(COMMAND_NAMESPACE, "node");
			props.setProperty(COMMAND_DESCRIPTION, "List node columns");
			registerService(bc, factory, TaskFactory.class, props);
		}
		{

...
public class ListColumnsTaskFactory extends AbstractTaskFactory {
	...
	public ListColumnsTaskFactory(CyApplicationManager appMgr, CyTableManager mgr,
	...
	public TaskIterator createTaskIterator() {
		return new TaskIterator(new ListColumnsTask(cyAppManager, cyTableManager, cyNetworkTableManager, serviceRegistrar));
	}
